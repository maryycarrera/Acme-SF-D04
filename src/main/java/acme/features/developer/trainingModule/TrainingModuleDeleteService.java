...
@Service
public class TrainingModuleDeleteService extends AbstractService<Developer, TrainingModule> {
	...
	public void perform(final TrainingModule object) {
		...
		sessions = this.trainingModuleRepo.findAllTrainingSessionByTrainingModuleId(object.getId());
		this.trainingModuleRepo.deleteAll(sessions);
		this.trainingModuleRepo.delete(object);
	}
