...
<jstl:choose>
    <jstl:when test="${averageNumberOfAuditRecords == null && maximumNumberOfAuditRecords == null}">
        <th scope="row">
            <strong>
                <acme:message code="auditor.auditor-dashboard.form.label.no-audit-records"/>
            </strong>
        </th>
    </jstl:when>
    <jstl:otherwise>
